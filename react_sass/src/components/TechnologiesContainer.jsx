...
const technologies = [
    ...
    {id: "sql", name: "SQLServer", icon: <DiMsqlServer/>, conhecimento: 4},
    {id: "postgres", name: "PostgreSQL", icon: <DiPostgresql/>, conhecimento: 4},
    {id: "mysql", name: "MySQL", icon: <DiMysql/>, conhecimento: 3},
